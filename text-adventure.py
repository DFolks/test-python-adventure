...
def room_1():
  ...
  if "west" in choice:
    ...
    game_over("""You carefully go through the narrow passage heading east. 
...
def room_2():
  ...
  if "west" in choice:
    game_over("""You follow the bright path. As you walk, the light gets 
...
def room_3():
  ...
  if beast_alive:
    ...
    if "east" in choice: 
      game_over("""As you run towards the east passage, the beast leaps in front 
      ...
      game_over("""You jump in the dark. It wasn't such a good idea, though.
...
def room_4():
  ...
  if dragon_alive:
    ...
    if "east" in choice:
      ...
      game_over("""The passage leads to the surface. You are free! You have won the game!""")
    else:
      room_4()
